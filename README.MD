...
Code: https://github.com/xjpp2016/USAD
...
> **Note:** For three-branch fusion testing, please copy (or move) the trained models from `trained_models/` to `saved_models/`, overwriting the existing model files if necessary.
